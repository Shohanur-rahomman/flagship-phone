...
const PhoneContainer = ({ phones }) => {
    ...
    return (
        <>
            ...
            <button href="#_" className="relative mb-10 mt-10 cursor-pointer inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-indigo-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
                ...
                <span className="relative w-full text-left transition-colors duration-200 ease-in-out group-hover:text-white">Show All</span>
            </button>
        </>
    );
};
