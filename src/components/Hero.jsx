            ...
            <div className='text-center space-y-4'>
                ...
                <form onSubmit={(e) => {
                    ...
                    <input
                        ...
                        className='py-3 px-4 rounded mb-4 md:mb-0  mr-4 shadow-md w-2/4' type="text" placeholder='search your favorite phone' />
                    <button type='submit' href="#_" className="relative cursor-pointer inline-block text-lg group">
